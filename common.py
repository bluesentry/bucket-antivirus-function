...
AV_SCAN_ROLE_ARN = os.getenv("AV_SCAN_ROLE_ARN")
AV_SCAN_SKIP_METADATA = os.getenv("AV_SCAN_SKIP_METADATA", "av-scan-skipped")
...
AV_STATUS_CLEAN_SNS_ARN = os.getenv("AV_STATUS_CLEAN_SNS_ARN")
...
AV_DELETE_SNS_ARN = os.getenv("AV_DELETE_SNS_ARN")
