...
AV_SCAN_START_TIMESTAMP_METADATA = os.getenv("AV_SCAN_START_TIMESTAMP_METADATA", "av-start-timestamp")
AV_SCAN_RESULT_TIMESTAMP_METADATA = os.getenv("AV_SCAN_RESULT_TIMESTAMP_METADATA", "av-result-timestamp")
