...
AV_DEFINITION_S3_EXTRA_PREFIX = os.getenv("AV_DEFINITION_S3_EXTRA_PREFIX", "clamav_extra_defs")
AV_DEFINITION_PATH = os.getenv("AV_DEFINITION_PATH", "/tmp/clamav_defs")
AV_DEFINITION_EXTRA_PATH = os.getenv("AV_DEFINITION_EXTRA_PATH", "/tmp/clamav_extra_defs")
...
AV_USE_FANGFRISCH = str_to_bool(os.getenv("AV_USE_FANGFRISCH", "False"))
