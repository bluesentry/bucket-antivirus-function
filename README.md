...
| AV_QUARANTINE_S3_BUCKET | Bucket for receiving infected files |  | No |
...
| AV_STATUS_INFECTED_ONLY | Controls whether only infected status results should be published | False | No |
